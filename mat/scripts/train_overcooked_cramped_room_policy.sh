...
--n_training_threads 8 --n_rollout_threads 16 --num_mini_batch 1 --episode_length 100 --num_env_steps 5000000 \
...
--preference_model_dir "REPLACE/WITH/PATH/TO/YOUR/reward_model_<epoch>.pt" \
